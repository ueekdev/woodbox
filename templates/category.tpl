			...
			<div class="category-screen">
				{% if has_filters_available and not settings.filters_desktop_modal %} 
					<div class="sidebar-area">
						{% include "snipplets/breadcrumbs.tpl" %}
						<div class="filters-sidebar d-none d-md-block visible-when-content-ready">
							<h3>Categorias</h3>
							{% if products %}
								{% if filter_categories is not empty %}
				...
				{% endif %}
				<div class="product-list-area" data-store="category-grid-{{ category.id }}">
					{% if category_banner %}
						{% include 'snipplets/category-banner.tpl' %}
					{% endif %}
					<div class="filter-and-sort">
						...
						<a href="#" class="js-modal-open js-fullscreen-modal-open d-md-none open-filter" data-toggle="#nav-filters" data-modal-url="modal-fullscreen-filters" data-component="filter-button">
							<iconify-icon icon="hugeicons:filter-horizontal"></iconify-icon>
							{{ 'Filtrar' | t }}
						</a>
					</div>
					{% if products %}
