...
{% set header_transparent_foreground = settings.head_transparent_contrast_options ?
settings.header_transparent_foreground_color : '' %}
...
--other-title-font: "Source Serif Pro", var(--main-title-font);
}
